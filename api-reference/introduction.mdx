...
{
  "agent_context": {
    "objective": "Determine whether CVE-2026-12345 is relevant to our environment.",
...
<CardGroup cols={2}>
  <Card title="Auth" icon="key" href="/api-reference/endpoint/auth-token">
    Mint tokens, manage API keys, and connect MCP clients.
  </Card>
  <Card title="Resolution" icon="scan-search" href="/api-reference/endpoint/entity-resolution">
    Normalize raw inputs into canonical Kyberis entities.
  </Card>
  <Card title="Evidence" icon="file-search" href="/api-reference/endpoint/evidence">
    Retrieve bounded evidence for specific claims.
  </Card>
  <Card title="Relationships" icon="git-branch" href="/api-reference/endpoint/relationships">
    Pivot through bounded relationships for canonical entities.
  </Card>
  <Card title="Prioritize" icon="list-ordered" href="/api-reference/endpoint/prioritize">
