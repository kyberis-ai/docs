...
<CardGroup cols={2}>
  ...
  <Card title="Install MCP" icon="plug" href="/install/mcp">
    Connect Claude, Cursor, Codex, or a generic MCP client to Kyberis.
  </Card>
  <Card title="Investigate a CVE" icon="shield-alert" href="/guides/investigate-cve">
...
<CardGroup cols={3}>
  <Card title="API keys" icon="key" href="/development">
    Authenticate directly with REST APIs or mint short-lived bearer tokens.
  </Card>
  <Card title="Skills" icon="sparkles" href="/install/skills">
